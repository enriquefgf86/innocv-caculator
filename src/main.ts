...
import calculatorActions from './components/calculator-actions-grid/calculator-actions-grid.vue';
import calculatorSymbols from './components/calculator-symbols-grid/calculator-symbols-grid.vue';
...
app.component("CalculatorActions", calculatorActions);
app.component("CalculatorSymbols", calculatorSymbols);
